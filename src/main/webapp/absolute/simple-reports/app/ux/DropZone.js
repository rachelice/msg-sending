...
Ext.define('SimpleReports.ux.DropZone', {
    ...
    onNodeOver: function(node, dragZone, e, data) {
        ...
        if(data.records[0] instanceof SimpleReports.model.List) {
