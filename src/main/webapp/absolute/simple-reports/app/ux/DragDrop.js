/**
 * @class SimpleReports.ux.DragDrop
 ...
 */
Ext.define('SimpleReports.ux.DragDrop', {
    extend: 'Ext.tree.plugin.TreeViewDragDrop',
    alias: 'plugin.tasksdragdrop',
    requires: [
        'Ext.view.DragZone',
        'SimpleReports.ux.DropZone'
    ], 
     ...
     * @param {SimpleReports.model.Group} group     The group that the task was dropped on
     */
     ...
     * @param {SimpleReports.model.Group} group         The group that was dropped
     * @param {SimpleReports.model.Group} overGroup     The group that the group was dropped on
    ...
    onViewRender : function(view) {
        ...
        if (me.enableDrop) {
            me.dropZone = Ext.create('SimpleReports.ux.DropZone', {
                view: view,
