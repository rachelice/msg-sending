/**
 * @class SimpleParams.ux.ReminderColumn
 * @extends Ext.grid.column.Column
 * A grid column for selecting reminder times
 */
Ext.define('SimpleParams.ux.ReminderColumn', {
     ...
     */
    renderer : function(value, metaData, param, rowIndex, colIndex, store, view){
        var cssPrefix = Ext.baseCSSPrefix,
            cls = [cssPrefix + 'grid-reminder'];

        if(param.get('done') || !param.get('due')) {
            // if the param is done or has no due date, a reminder cannot be set
            return '';
        }
