...
<head>
	...
	<script src="${ctx }/activiti/js/common/plugins/blockui/jquery.blockUI.js" type="text/javascript"></script>
	...
	<script src="${ctx }/activiti/js/module/form/dynamic/dynamic-form-handler.js" type="text/javascript"></script>
</head>
		...
		<tr>
			...
			<td>
				<c:if test="${empty task.assignee }">
					<a class="claim" href="${ctx }/activiti/form/dynamic/task/claim/${task.id}">签收</a>
				</c:if>
