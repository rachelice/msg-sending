...
<head>
	...
	<script src="${ctx }/activiti/js/module/form/formkey/formkey-form-handler.js" type="text/javascript"></script>
</head>
		...
		<tr>
			...
			<td>
				<c:if test="${empty task.assignee }">
					<a class="claim" href="${ctx }/activiti/form/formkey/task/claim/${task.id}">签收</a>
				</c:if>
