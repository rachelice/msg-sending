package org.activiti.sit.web.oa.leave;
...
import org.activiti.sit.service.oa.leave.LeaveManager;
import org.activiti.sit.service.oa.leave.LeaveWorkflowService;
import org.activiti.sit.util.Page;
import org.activiti.sit.util.PageUtil;
import org.activiti.sit.util.UserUtil;
import org.activiti.sit.util.Variable;
 ...
 */
@Controller
@RequestMapping(value = "/activiti/oa/leave")
public class LeaveController {
  ...
  public String startWorkflow(Leave leave, RedirectAttributes redirectAttributes, HttpSession session) {
    ...
    return "redirect:/activiti/oa/leave/apply";
  }
  ...
  public ModelAndView taskList(HttpSession session, HttpServletRequest request) {
    ModelAndView mav = new ModelAndView("/activiti/oa/leave/taskList");
  ...
  public ModelAndView runningList(HttpServletRequest request) {
    ModelAndView mav = new ModelAndView("/activiti/oa/leave/running");
    Page<Leave> page = new Page<Leave>(PageUtil.PAGE_SIZE);
    int[] pageParams = PageUtil.init(page, request);
  ...
  public ModelAndView finishedList(HttpServletRequest request) {
    ModelAndView mav = new ModelAndView("/activiti/oa/leave/finished");
    Page<Leave> page = new Page<Leave>(PageUtil.PAGE_SIZE);
    int[] pageParams = PageUtil.init(page, request);
  ...
  public String claim(@PathVariable("id") String taskId, HttpSession session, RedirectAttributes redirectAttributes) {
    ...
    return "redirect:/activiti/oa/leave/list/task";
  }
