package org.activiti.sit.web.workflow;
...
import org.activiti.sit.service.activiti.WorkflowProcessDefinitionService;
import org.activiti.sit.service.activiti.WorkflowTraceService;
import org.activiti.sit.util.Page;
import org.activiti.sit.util.PageUtil;
import org.activiti.sit.util.UserUtil;
import org.activiti.sit.util.WorkflowUtils;
...
public class ActivitiController {
  ...
  public ModelAndView processList(HttpServletRequest request) {
    ModelAndView mav = new ModelAndView("activiti/workflow/process-list");
  ...
  public String redeployAll(@Value("#{APP_PROPERTIES['export.diagram.path']}") String exportDir) throws Exception {
    ...
    return "redirect:/activiti/workflow/process-list";
  }
...
//    Context.setProcessEngineConfiguration(defaultProcessEngine.getProcessEngineConfiguration());
  ...
  public String convertToModel(@PathVariable("processDefinitionId") String processDefinitionId)
    ...
    return "redirect:/activiti/workflow/model/list";
  }
