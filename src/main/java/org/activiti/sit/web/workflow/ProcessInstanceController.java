...
@Controller
@RequestMapping(value = "/activiti/workflow/processinstance")
public class ProcessInstanceController {
  ...
  public ModelAndView running(Model model, HttpServletRequest request) {
    ModelAndView mav = new ModelAndView("/activiti/workflow/running-manage");
  ...
  public String updateState(@PathVariable("state") String state, @PathVariable("processInstanceId") String processInstanceId,
    ...
    return "redirect:/activiti/workflow/processinstance/running";
  }
}
