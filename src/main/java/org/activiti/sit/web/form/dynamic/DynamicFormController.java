package org.activiti.sit.web.form.dynamic;
...
import org.activiti.sit.util.Page;
import org.activiti.sit.util.PageUtil;
import org.activiti.sit.util.UserUtil;
...
/**
 * 动态表单Controller
 * 了解不同表单请访问：http://www.sit.me/activiti/2012/08/05/diff-activiti
 * -workflow-forms.html
 * 
 * @your name
 */
@Controller
@RequestMapping(value = "/activiti/form/dynamic")
public class DynamicFormController {
  ...
  public ModelAndView processDefinitionList(Model model, HttpServletRequest request) {
    ModelAndView mav = new ModelAndView("/activiti/form/dynamic/dynamic-form-process-list");
  ...
  public String completeTask(@PathVariable("taskId") String taskId, RedirectAttributes redirectAttributes, HttpServletRequest request) {
    ...
    if (user == null || StringUtils.isBlank(user.getId())) {
      return "redirect:/activiti/login?timeout=true";
    }
    ...
    return "redirect:/activiti/form/dynamic/task/list";
  }
  ...
  public String submitStartFormAndStartProcessInstance(@PathVariable("processDefinitionId") String processDefinitionId, RedirectAttributes redirectAttributes,
    ...
    return "redirect:/activiti/form/dynamic/process-list";
  }
  ...
  public ModelAndView taskList(Model model, HttpServletRequest request) {
    ModelAndView mav = new ModelAndView("/activiti/form/dynamic/dynamic-form-task-list");
    User user = UserUtil.getUserFromSession(request.getSession());
  ...
  public ModelAndView running(Model model, HttpServletRequest request) {
    ModelAndView mav = new ModelAndView("/activiti/form//running-list");
  ...
  public ModelAndView finished(Model model, HttpServletRequest request) {
    ModelAndView mav = new ModelAndView("/activiti/form/finished-list");
