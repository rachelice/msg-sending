package com.sunshineroad.driverschool.mspmsgtask.entity;
 ...
 * @Description: 短信任务
 * @author  
 * @date 2014-02-24 12:47:03
 * @version V1.0   
 *
 */
@Entity
@Table(name = "msp_msg_task", schema = "")
public class MspMsgTask extends BaseEntity {
	/**id*/
	...
	@SequenceGenerator(name="sequence",sequenceName="msp_msg_task_seq",allocationSize=1)
