package com.sunshineroad.driverschool.mspmsglist.entity;
 ...
 * @Description: 短信清单
 * @author  
 * @date 2014-02-24 12:49:24
 * @version V1.0   
 *
 */
@Entity
@Table(name = "msp_msg_list", schema = "")
public class MspMsgList extends BaseEntity {
	/**id*/
	...
	@SequenceGenerator(name="sequence",sequenceName="msp_msg_list_seq",allocationSize=1)
